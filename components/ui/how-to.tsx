		...
		<div className='space-y-8 bg-[#f5f5f5] p-6 rounded-xl font-serif'>
			<div className='bg-white rounded-xl p-6 lg:px-40 shadow-lg border text-black space-y-8 border-white/10'>
				<section className='mb-3'>
					...
					<ol className='list-decimal list-inside space-y-2 text-black my-3'>
				...
				<section>
					...
					<table className='w-full table-auto border border-gray-300 rounded-lg border-collapse text-black mb-3'>
						<tbody>
							...
							<tr className='border-b border-gray-200'>
								...
								<td className='p-2'>
									...
									analyzing data stored within them. These have the advantage of
									being directly integrated, with the disadvantage of being
							...
							<tr className='border-b border-gray-200'>
								...
								<td className='p-2'>
									...
									metrics and measures are repeatable and consistent over time.
									They sit between the database and the analyst. Increasingly,
									this is seen as a requirement for truly useful conversational
									analytics.
								</td>
							</tr>
							...
							<tr className='border-b border-gray-200'>
								<td className='font-bold p-2 align-top border-r'>AI Analyst</td>
								<td className='p-2'>
									These tools often mix SQL with Python, sometimes in a notebook
									format. They aim to be a one-to-one replacement for a data
									analyst, including visualization and summarization.
								</td>
							</tr>
							...
							<tr className='border-b border-gray-200'>
								...
								<td className='p-2'>
									...
									Google Analytics, Facebook Ads, Shopify, etc. They are aiming
									for the small business/indie hacker market.
								</td>
							</tr>
							...
							<tr className='border-b border-gray-200'>
								<td className='font-bold p-2 align-top border-r'>Data IDEs</td>
								<td className='p-2'>
									“Cursor for Data.” These tools assume people will continue to
									interact directly with SQL but need the nice features of an
									IDE, like autocomplete, schema exploration, etc.
								</td>
							</tr>
				...
				<section>
					...
					<ul className='list-disc list-inside space-y-2 text-black mt-3'>
						<li>
							<span className='font-bold underline'>What it is for:</span>{' '}
							Listing the problems this tool addresses.
						</li>
						<li>
							<span className='font-bold underline'>Who it is for:</span>{' '}
